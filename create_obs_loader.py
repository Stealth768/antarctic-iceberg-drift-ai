...
obs_code = """from __future__ import annotations
...
(Path('src/data') / 'observations.py').write_text(obs_code, encoding='utf-8')
print("PASS: Created src/data/observations.py successfully!")
